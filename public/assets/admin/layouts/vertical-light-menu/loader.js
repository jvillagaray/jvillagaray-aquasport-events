window.addEventListener("load", function(){
    ...
    if (equationThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', 'https://designreset.com/equation/src/assets/img/logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', 'https://designreset.com/equation/src/assets/img/logo2.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
